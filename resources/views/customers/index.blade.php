...
<!-- Content Header (Page header) -->
    ...
    <section class="content-header">
        <div class="row">
          <div class="col-md-3">
              <h2 class="top-left-header" style="margin: 0px 0px 0px 0px;">Customers </h2>
          </div>
          <div class="col-md-3">
          </div>
          ...
          <div class="col-md-5 text-right">
              <ul class="list-inline text-right">
                  <li>
                      <a href="/customers/create"><button type="button" class="btn btn-block btn-primary pull-right">Add</button></a>
                  </li>
