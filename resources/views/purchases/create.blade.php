      ...
      <div class="row">
        ...
        <div class="col-md-12">
          ...
          <div class="box box-primary">
            ...
            <!-- /.box-header -->
            <!-- form start -->
            <form role="form" method="POST" action="/purchases" id="add_purchase_form">
              @csrf
              ...
              <div class="box-body">
                ...
                <div class="col-md-6">	
					<div class="form-group">
	                  ...
	                  <input name="bill_no" id="bill_no" type="text" class="form-control" placeholder="Bill Number" value="{{old('bill_no')}}">
	                </div>
              	</div>
                <div class="col-md-6">  
          <div class="form-group">
                    <label>Purchase Date</label>
                    <input name="purchase_date" id="purchase_date" type="text" class="form-control" placeholder="Purchase Date" value="{{old('purchase_date')}}" readonly>
                  </div>
                </div>
                <div class="col-md-6">  
                  <div class="form-group">
