    ...
    <section class="content">
      <div class="row">
        ...
        <div class="col-md-12">
          ...
          <div class="form-group">
                    <label>Color</label>
                    <input name="color" type="text" class="form-control" placeholder="Color" value="{{$product->color}}">
                  </div>
                </div>
                ...
                <div class="col-md-6">	
					<div class="form-group">
	                  ...
	                  <select name="is_active" class="form-control select2" style="width: 100%;">
		                  <option  value="">Select</option>
		                  <option value="1" @if ($product->is_active=='1') selected="selected" @endif>Yes</option>
		                  <option value="0" @if ($product->is_active=='0') selected="selected" @endif>No</option>
	                </select>
	                </div>
                </div>
